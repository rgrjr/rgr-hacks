;;;****************************************************************************
;;;
;;;    GNU emacs mouse hackery (version 19 only).
;;;
...
;;; rgr-mouse-edit-thing: remove debugging message.  -- rgr, 27-Jan-95.
...
;;; rgr-mouse-edit-thing --> ilisp-mouse-edit-thing.  -- rgr, 8-Apr-03.
;;; 
;;;
...
(defun rgr-install-mouse-commands ()
  "Install some Symbolics-like mouse commands (emacs 19 only)."
  ...
  ;; Need to flush C-down-mouse-2, or C-mouse-2 doesn't work in 19.30.  -- rgr,
  ;; 25-Mar-96.
